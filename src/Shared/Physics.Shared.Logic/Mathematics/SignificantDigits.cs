// Source: https://stackoverflow.com/questions/158172/formatting-numbers-with-significant-figures-in-c-sharp
...
namespace Physics.Shared.Mathematics
{
	...
	{
		public static double RoundSignificantDigits(this double value, int significantDigits)
		{
			int unneededRoundingPosition;
			return RoundSignificantDigits(value, significantDigits, out unneededRoundingPosition);
		}

		public static string ToSignificantDigitsString(this float value, int significantDigits) => ((double)value).ToSignificantDigitsString(significantDigits);

		public static string ToSignificantDigitsString(this double value, int significantDigits)
		{
