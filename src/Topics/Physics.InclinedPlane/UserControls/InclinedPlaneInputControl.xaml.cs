...
namespace Physics.InclinedPlane.UserControls
{
    public sealed partial class InclinedPlaneInputControl : UserControl
    {
        public InclinedPlaneInputControl()
        {
            ...
            DriftCoefficientNumberBox.SetupFormatting(increment: 0.001, fractionDigits: 2, smallChange: 1);
            HorizontalDriftCoefficientNumberBox.SetupFormatting(increment: 0.001, fractionDigits: 2, smallChange: 1);
