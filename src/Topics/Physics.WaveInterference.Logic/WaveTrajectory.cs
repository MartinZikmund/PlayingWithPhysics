...
namespace Physics.WaveInterference.Logic
{
	public class WaveTrajectory : IWaveTrajectory
	{
		...
		private readonly WavePhysicsService _wavePhysicsService;

		public WaveTrajectory(WaveInfo wave)
		{
			if (wave is null)
			{
			...
			_waveInfo = wave;
			_wavePhysicsService = new WavePhysicsService(wave);
		}

		public float StartX => _wavePhysicsService.StartX;
